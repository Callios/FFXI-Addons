...
function init_gear_sets()
    ...
    Empy_Karagoz.Feet_Tatical = "Cirque Scrape +1"

  Taeon_Tank = {}
  Taeon_Tank.taeon_head_tank   = { name="Taeon Chapeau", augments={'Pet: "Regen"+2','Pet: Damage taken -2%',}}
  Taeon_Tank.taeon_body_tank   = { name= "Taeon Tabard", augments = {'STR+6 AGI+6', 'Accuracy+12 Attack+12', '"Triple Atk."+2'}}
  Taeon_Tank.taeon_hands_tank  = { name="Taeon Gloves", augments={'Evasion+23','Pet: "Regen"+2','Pet: Damage taken -3%',}}
  Taeon_Tank.taeon_legs_tank   = { name="Taeon Tights", augments={'Attack+20','Pet: "Regen"+3','Pet: Damage taken -3%',}}
  Taeon_Tank.taeon_feet_tank   = { name="Taeon Boots", augments={'Pet: "Regen"+2','Pet: Damage taken -4%',}}
    ...
    Visucius.PetandMasterTP = {
      name="Visucius's Mantle", 
      augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20',
      'Accuracy+20 Attack+20','Pet: Accuracy+10 Pet: Rng. Acc.+10',
      'Pet: Haste+10',
      'Pet: Damage taken -5%',}
    }
    ...
    sets.precast.WS = {
      ...
      back=Visucius.PetandMasterTP,waist="Fotia Belt",legs="Mpaca's Hose",feet="Mpaca's Boots"}
    ...
    sets.idle.Pet.Engaged = {
      ...
      head="Mpaca's Cap",neck="Shulmanu Collar",ear1="Burana Earring",ear2="Enmerkar Earring",
      body="Mpaca's Doublet",hands="Mpaca's Gloves",ring1="Defending Ring",ring2="Cath Palug ring",
      back=Visucius.PetandMasterTP,waist="Klouskap Sash",legs="Mpaca's Hose",feet="Mpaca's Boots"
    }
